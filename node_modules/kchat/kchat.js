        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                if(obj.res_code=='K_1'){
                    ...
                    console.log('khong co admin nao online')
                }
            }
        }
...
function K_Main(obj){
    if(obj.device==2){
        ...
        if(obj.online==1){
            ...
            K_iframeBoxchat(html_iframeBoxchat(obj.con_prompt,obj.con_hi,obj.con_boxchat_banner,obj.use_name));
            if(obj.con_status=="0"){
                K_closemini(1)
            }else{
        ...
        console.log('thiet bi cua ban la mobile');
    }
}
...
function html_iframeBoxchat(nhacnho,loichao,banner,user){
    var str_user='';
    if(user!=''){
        str_user=user;
    }
    var arr=loichao.split("|");
    var text0='',text1='';
    if(typeof arr[0] !== "undefined"){text0=arr[0];}
    if(typeof arr[1] !== "undefined"){text1=arr[1];}
    var str_loichao='<span style="font-size: 14px;"><span style="font-size: 14px; font-family: Arial">'+text0+'</span><span style="FONT-SIZE: 16px; FONT-FAMILY: Arial; COLOR: #e53333"><strong> '+str_user+' </strong></span><span style="FONT-SIZE: 14px; FONT-FAMILY: Arial">'+text1+'</span></span><span style="FONT-SIZE: 12pt;"></span></p><p class="MsoNormal" style="TEXT-ALIGN: left"><span style="FONT-SIZE: 14px; FONT-FAMILY: Arial; COLOR: #337fe5"></span><span style="FONT-SIZE: 14px; FONT-FAMILY: Arial; COLOR: #337fe5"></span></p><p class="MsoNormal" style="TEXT-ALIGN: left">' +
        '<span style="font-size: 14px; font-family: Arial; color: #337fe5">[</span><span style="font-size: 14px; font-family: Arial; COLOR: #337fe5;"> cuoc hoi theo hoan toan duoc bao mat !</span><span style="font-size: 14px; font-family: Arial; color: #337fe5">]</span>';
    var str_nhacnho='';
    if(nhacnho!=''){
        str_nhacnho='<p id="prompttop" style="word-break:break-all;white-space:nowrap;text-overflow:ellipsis;display:inline-block;overflow:hidden;">'+nhacnho+'</p>';
    }
    var str_banner='';
    if(banner!='') {
        var str_banner = '<img style="max-width: 100%; text-align: center" src="' + banner + '">';
    }
